...
# Tampilan Metrics Angka Ringkasan (Bawaan Streamlit yang minimalis)
...
# Warna grafik akan otomatis mengikuti Accent/Primary color bertema hijau yang Anda setel di Streamlit
